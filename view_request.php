                  ...
                  <!--===center detail side===-->
						<div class="col-lg-12">
							...
							<!--===home center===-->
                              ...
                              <thead>
                                <tr>
								<th>No</th> <th>Full Name</th><th>Sex</th><th>Date of Brith</th> <th>Nationality</th> <th>Marital Status</th> <th>Date</th> <th>Time</th><th>Request Number</th> <th>Go to LAB</th>  </tr>
                    ...
                    <tbody>
                      ...
                      <?php
                        include("connection.php");
							$stmt = $conn->query("SELECT * FROM request_table r, user_table u where u.ID_user_table=r.ID_user_table and request_status='request' ");
                      ...
                      ?>
                                  ...
                                  <tr>
                                     ...
                                     <td><?php echo $to_days_date ?> </td>
                                     <td><?php echo $current_times ?> </td>
                                     <td>Number: <?php echo $request_number ?> </td>
                                     <td><a  href="lab_form.php?uId=<?php echo $ID_user_table ?> "> <span class="fa fa-adjust"></span> </a></td>
