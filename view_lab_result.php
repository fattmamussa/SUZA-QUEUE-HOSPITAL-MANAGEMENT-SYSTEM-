                  ...
                  <!--===center detail side===-->
						<div class="col-lg-12">
							...
							<!--===home center===-->
                              ...
                              <thead>
                                <tr>
								<th>No</th> <th>Full Name</th><th>Sex</th><th>Date of Brith</th> <th>Nationality</th> <th>Marital Status</th> <th>LAB Results</th>  </tr>
                    ...
                    <tbody>
                      ...
                      <?php
                        include("connection.php");
							$stmt = $conn->query("SELECT * FROM request_table r, user_table u where u.ID_user_table=r.ID_user_table and request_status='see_doctor' ");
                      ...
                      ?>
                                  ...
                                  <tr>
                                     ...
                                     <td><a  href="lab_result.php?uId=<?php echo $ID_user_table ?> "> <span class="fa fa-adjust"></span> </a></td>
